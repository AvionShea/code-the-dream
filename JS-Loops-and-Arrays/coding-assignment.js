...
console.log("Q2: ", pyramidCounting(4));
// console.log("Q2: ", pyramidCounting(46));
...
console.log("Q3:", noVowels("adventurous"));
// console.log("Q3:", noVowels("Double Trouble"));
...
// PUT YOUR CODE HERE
let empty = [];
let full = ["This", 32, "is", "a", 24, "full", "array", ".", 11];
...
console.log("Q7: ", getElementAt(full, 9));
...
// PUT YOUR CODE HERE
const insertInArray = (array) => {
    let newArray;
    newArray = array.toSpliced(1, 0, 0);
    return newArray;
};
...
// PUT YOUR CODE HERE
let compare = ["This", 32, "is", "a", 24, "full", "array", ".", 11];
let partial = ["This", 32, "is", "a", 24, "empty", "string", 12, "!"];
...
console.log("Q9: ", compareArrays(compare, full));
console.log("Q9: ", compareArrays(compare, partial));
// ---------- QUESTION 10 ----------
...
// PUT YOUR CODE HERE
const numbers = [154000, 25, 9985];
let sum = 0;

const calculateTotal = (sumArr) => {
...
// Q10 STRETCH GOAL
const calculateTotal2 = (sumArr) => (sumArr.reduce((a, b) => a + b));
console.log("Q10 Stretch Goal: ", calculateTotal2(numbers));
...
// Q11 STRETCH GOAL
const findEvens2 = (arr) => {
    return arr.filter((element) => element % 2 === 0);
}
console.log("Q11 Stretch Goal evens: ", findEvens2([10, 2, 35, 19, 72, 6, 930]));
// ---------- QUESTION 12 ----------
...
const makeSquares2 = (arr) => {
    return arr.map((element) => element * element);
};
console.log("Q12 STRETCH GOAL: ", makeSquares2([2, 5, 8]));
