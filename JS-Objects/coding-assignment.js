...
// STRETCH GOAL
const stretchGoalMonth = () => {
    const months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    const today = months[new Date().getMonth()]
    return today
}
console.log("Q5 Stretch Goal: ", stretchGoalMonth());
...
// PUT YOUR CODE HERE
const birthday = new Date("2025-08-11");
...
// PUT YOUR CODE HERE
const startTime = new Date("2025-07-26T12:37:00");
const endTime = new Date("2025-07-26T15:19:00");
const timeDifference = (startTime, endTime) => {
    // STRETCH GOAL
    if (isNaN(startTime.getTime()) || isNaN(endTime.getTime())) {
        return "Invalid time(s). Please try again."
    } else {
...
// EXAMPLE OUTPUT:
//    Q9 convertTemp: 0 32
// Create logs for several different celsius temperatures
...
const circumferenceOfCircle = () => {
    const circumference = 2 * Math.PI * radius(diameterOfCircle);
    return circumference;
};

const areaOfCircle = () => {
    const r = radius(diameterOfCircle);
...
console.log(`Q11:, Radius: ${radius(diameterOfCircle)}, Circumference: ${circumferenceOfCircle()}, Area: ${areaOfCircle()}`);
// Don't forget your console.logs!
...
console.log("Total with Tip: $", billTotal.toFixed(2));
// Don't forget your console.logs!
