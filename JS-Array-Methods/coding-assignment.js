...
// PUT YOUR CODE HERE
let names = ["Sara Barnes", "Angela Mack", "James Jordan", "Megan Smith", "Chris Green"];
...
// PUT YOUR CODE HERE
const trees = [
    { type: "Redwood", height: "130m" },
    { type: "Dogwood", height: "25m" },
    { type: "Bradford Pear Tree", height: "15m" }
];

function logTreeType(treesArr) {
    console.log("Q2 logTreeType: ");
    treesArr.forEach((tree) => console.log(tree.type));
};
logTreeType(trees);
...
// PUT YOUR CODE HERE
let myNumbers = [13250, 54000, 10, 15];
function totalPoints(numArr) {
    let sum = 0;
...
// PUT YOUR CODE HERE
const myWords = ["I", "will", "be", "a", "paid", "software", "engineer", "before", "2026", "!"];
function buildSentence(wordArr) {
    let sentence = "";
    wordArr.forEach((word) => sentence += " " + word);
    return sentence;
};
console.log(`Q4 buildSentence [${myWords}]: `, buildSentence(myWords));
...
// PUT YOUR CODE HERE
const decimals = [0.75, 1.0, 0.51, 0.24];
function logPercentages(decimalArr) {
    decimalArr.forEach((decimal) => {
...
// PUT YOUR CODE HERE
const startingNums = [17, 12567, 457, 792];
function addThreeToAll(arrOfNums) {
    return arrOfNums.map((num) => num + 3)
};
console.log(`Q6 addThreetoAll [${startingNums}]: `, addThreeToAll(startingNums));
...
// PUT YOUR CODE HERE
const baseNums = [250, 84, 6, 8, 74];
function squareAll(baseArr) {
    return baseArr.map((num) => num ** 2);
}
console.log(`Q7 squareAll [${baseNums}]: `, squareAll(baseNums));
...
// PUT YOUR CODE HERE
let users = [
    { username: "avion.cobb", isAdmin: true },
    { username: "jane.doe", isAdmin: false },
    { username: "zara.hue", isAdmin: false },
    { username: "jade.stone", isAdmin: false },
    { username: "storm.orion", isAdmin: true }
];
function getUsernames(userArr) {
    return userArr.map((user) => user.username);
};
console.log(`Q9 getUsernames: `, getUsernames(users));
...
// PUT YOUR CODE HERE
function pluck(objArr, strKey) {
    return objArr.map((obj) => obj[strKey]);
};
console.log(`Q10 pluck "isAdmin":`, pluck(users, "isAdmin"));
...
// PUT YOUR CODE HERE
let numArr = [4, 41, 832, 72, 89, 120, 431, 505, 70];
function evenNumbers(arr) {
    return arr.filter((num) => num % 2 === 0);
};
console.log(`Q11 evenNumbers [${numArr}]: `, evenNumbers(numArr));
...
// PUT YOUR CODE HERE
let arrOfNums = [4, 41, 832, 72, 89, 120, 431, 505, 70];
function greaterThan100(arrOfNums) {
    return arrOfNums.filter((num) => num > 100);
};
console.log(`Q12 greaterThan100 [${arrOfNums}]: `, greaterThan100(arrOfNums));
...
//     { username: "storm.orion", isAdmin: true }
// ];
function nonAdminUsers(arrOfUserObj) {
    return arrOfUserObj.filter((user) => user["isAdmin"] === false);
}
console.log(`Q13 nonAdminsers: `, nonAdminUsers(users));
...
// PUT YOUR CODE HERE
function countAdminUsers(usersArr) {
    return usersArr.filter((user) => user["isAdmin"] === true).length;
};
console.log(`Q14 countAdminUsers: `, countAdminUsers(users));
...
function shorterThanX(arrOfStr, int) {
    return arrOfStr.filter((str) => str.length < int);
};
console.log(`Q15 shorterThanX 30: `, shorterThanX(strings, 30));
console.log(`Q15 shorterThanX 2: `, shorterThanX(strings, 2));
console.log(`Q15 shorterThanX 20: `, shorterThanX(strings, 20));
...
// PUT YOUR CODE HERE
let manyTypes = [4, "4", "four score", 80, { age: 80 }, ["nations"], { type: "free" }, "states"];
function onlyStrings(arrOfElements) {
    return arrOfElements.filter((element) => typeof element === "string");
};
console.log(`Q16 onlyStrings [${manyTypes}]: `, onlyStrings(manyTypes));
...
// PUT YOUR CODE HERE
let array = [4, 41, 832, 72, 89, 120, 431, 505, 70];
function firstOdd(arrOfNumbers) {
    return arrOfNumbers.find((num) => num % 2 !== 0);
};
console.log(`Q17 firsOdd [${array}]: `, firstOdd(array));
...
// PUT YOUR CODE HERE
let divArray = [4, 41, 832, 72, 89, 120, 431, 505, 70];
function divisibleByTen(arrNum) {
    return arrNum.find((num) => num % 10 === 0);
};
console.log(`Q18 divisibleByTen [${divArray}]: `, divisibleByTen(divArray));
...
function divisibleByX(array, int) {
    return array.find((num) => num % int === 0);
};
console.log(`Q19 divisibleByX [${divArray}]: `, divisibleByX(divArray, 3));
...
function startsWithLetter(arrOfStrings, letter) {
    if (typeof letter !== "string" || letter.length !== 1) {
        return "Error: Letter must be a string of length 1";
    } else {
        return arrOfStrings.find((str) => str.startsWith(letter));
    };

};
console.log(`Q20 startsWithLetter: `, startsWithLetter(jokeStrings, "I"));
console.log(`Q20 startsWithLetter: `, startsWithLetter(jokeStrings, "y"));
console.log(`Q20 startsWithLetter: `, startsWithLetter(jokeStrings, "dog"));